...
class Glass:
    ...
    def __str__(self) -> str:
        return f"Стакан объёмом = ({self.capacity_volume}. Объём жидкости в стакане = {self.occupied_volume})"   # TODO метод должен возвращать строку, которая содержит человеко-читаемую информацию
